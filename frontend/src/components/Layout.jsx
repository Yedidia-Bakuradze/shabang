                            ...
                            <div className="flex h-16 justify-between">
                                <div className="flex">
                                    <div className="flex flex-shrink-0 items-center cursor-pointer" onClick={() => navigate('/')}>
                                        <span className="text-2xl font-bold text-primary-600">ERD Designer</span>
                                    </div>
                                </div>
                                <div className="hidden sm:ml-6 sm:flex sm:items-center">
                                    {user ? (
                                        ...
                                        <div className="space-x-4">
                                            ...
                                            <Link to="/signup" className="bg-primary-600 text-white px-4 py-2 rounded-md hover:bg-primary-700 font-medium">Sign up</Link>
                                        </div>
                                    )}
                                </div>
                                ...
                                {user ? (
                                    <div className="space-y-1 px-2">
                                        <Disclosure.Button
                                            as="button"
                                            onClick={handleLogout}
                                            className="block w-full rounded-md px-3 py-2 text-base font-medium text-gray-500 hover:bg-gray-100 hover:text-gray-800 text-left"
                                        >
                                            Sign out
                                        </Disclosure.Button>
                                    </div>
