...
const Editor = () => {
    ...
    return (
        <Layout>
            <div className="h-[calc(100vh-64px)] w-full bg-white dark:bg-gray-900 flex">
                {/* Main canvas area with save button */}
                ...
                <div className="w-80 border-l border-gray-300 dark:border-gray-700 bg-gray-50 dark:bg-gray-800 overflow-y-auto">
                    <PropertyPanel />
                </div>
            </div>
        </Layout>
